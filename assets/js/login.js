document.addEventListener('DOMContentLoaded', function() {
    ...
    if (showRegister && loginForm && registerForm && loginTabBtn && registerTabBtn) {
    ...
    if (switchToRegister && loginForm && registerForm && loginTabBtn && registerTabBtn) {
    ...
    if (switchToLogin && loginForm && registerForm && loginTabBtn && registerTabBtn) {
